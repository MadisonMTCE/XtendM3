...
* WKF013            20240305  KVERCO      Supplier invoice approval run
*/
...
public class ProcessApproval extends ExtendM3Transaction {
  ...
  public void main() {
    ...
    Map<String, String> params = ["JOB": "EXT110", "TX30": "Invoice Approval Run", "XCAT": "010", "SCTY": "1", "XNOW": "1", "UUID": referenceId]; // single run - now
